...
export function ResetPasswordPage() {
  ...
  return <main className='auth-page'>
    <section className='auth-story'><Link className='auth-brand' to='/'><span className='brand-mark' aria-hidden='true'><img src='/vault-icon-dark.svg' alt='' /></span>Vault</Link><div><span className='auth-spectrum' /><h1>Uma nova senha. A mesma clareza para seguir em frente.</h1><p>Escolha uma senha exclusiva e mantenha o acesso ao seu dinheiro protegido.</p></div><blockquote>Segurança sem ruído.</blockquote></section>
